...
def image_create(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            new_image.save()
            create_action(request.user, 'agrego una imagen al bookmarks', new_image)
            messages.success(request, 'Imagen añadida con éxito')
    ...
    if image_id and action:
        try:
            ...
            if action == 'like':
                ...
                create_action(request.user, 'le gusta', image)
            else:
